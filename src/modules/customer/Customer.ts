...
export class Customer extends User {
    ...
    public placeOrderPhysically() : void {
        ...
        const order:PhysicalOrder = Order.createOrder<PhysicalOrder>(this,paymentReceipt,shippingAddress);
    ...
    public placeOrderDigitally() : void {
        ...
        const payment:Payment = new Payment();
        const paymentReceipt:PaymentReceiptSchema | string = payment.verify(new Upi("abc@gmail.com"));
        ...
        const order:DigitalOrder = Order.createOrder<DigitalOrder>(this,paymentReceipt)
        this.orders.push(order)
